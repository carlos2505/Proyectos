...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.TabSheet","com.vaadin.ui.TreeTable","com.vaadin.ui.Slider","com.vaadin.ui.OptionGroup","com.vaadin.ui.Button","com.vaadin.ui.TextField","com.vaadin.ui.Video","com.vaadin.ui.ComboBox","com.vaadin.ui.PasswordField","com.vaadin.ui.Link","com.vaadin.ui.Accordion","com.vaadin.ui.Form","com.vaadin.ui.CustomField","com.vaadin.ui.MenuBar","com.vaadin.ui.GridLayout","com.vaadin.ui.Window","com.vaadin.ui.FormLayout","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Embedded","com.vaadin.ui.Tree","com.vaadin.ui.Image","com.vaadin.server.FileDownloader","com.vaadin.ui.CssLayout","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.NativeSelect","com.vaadin.ui.Panel","com.vaadin.ui.DateField","com.vaadin.ui.PopupView","com.vaadin.ui.InlineDateField","com.vaadin.ui.TwinColSelect","com.vaadin.ui.VerticalLayout","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.CustomComponent","com.vaadin.ui.TextArea","com.vaadin.ui.JavaScript","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Upload","com.vaadin.ui.CheckBox","com.vaadin.ui.ListSelect","com.vaadin.ui.UI","com.vaadin.ui.Audio","com.vaadin.ui.CustomLayout","com.vaadin.ui.Flash","com.vaadin.ui.Label","com.vaadin.ui.NativeButton","com.vaadin.ui.Table","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.HorizontalSplitPanel",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"registeredEventListeners", "childData", "readOnly", "caption", "styles", "resources", "spacing", "immediate", "height", "marginsBitmask", "errorMessage", "width", "enabled", "primaryStyleName", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"height", "immediate", "errorMessage", "propertyReadOnly", "readOnly", "modified", "tabIndex", "styles", "caption", "hideErrors", "required", "width", "description", "primaryStyleName", "enabled", "id", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"id", "errorMessage", "description", "resources", "primaryStyleName", "immediate", "propertyReadOnly", "hideErrors", "tabIndex", "required", "caption", "styles", "height", "modified", "registeredEventListeners", "enabled", "readOnly", "width", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"immediate", "tabIndex", "enabled", "primaryStyleName", "registeredEventListeners", "errorMessage", "styles", "width", "caption", "height", "description", "id", "resources", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"caption", "primaryStyleName", "enabled", "readOnly", "childData", "description", "styles", "resources", "errorMessage", "immediate", "id", "marginsBitmask", "columns", "width", "registeredEventListeners", "spacing", "height", "rows", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"button", "ctrlKey", "relativeX", "shiftKey", "type", "metaKey", "altKey", "clientX", "relativeY", "clientY", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"id", "marginsBitmask", "width", "primaryStyleName", "styles", "registeredEventListeners", "readOnly", "resources", "caption", "description", "childData", "errorMessage", "enabled", "spacing", "height", "immediate", });
            ...
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"childCss", "readOnly", "registeredEventListeners", "enabled", "height", "description", "primaryStyleName", "errorMessage", "styles", "id", "width", "immediate", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"disableOnClick", "caption", "resources", "htmlContentAllowed", "styles", "primaryStyleName", "id", "height", "immediate", "registeredEventListeners", "enabled", "description", "width", "errorMessage", "readOnly", "clickShortcutKeyCode", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"height", "errorMessage", "caption", "resources", "registeredEventListeners", "immediate", "required", "readOnly", "width", "id", "hideErrors", "primaryStyleName", "styles", "propertyReadOnly", "modified", "description", "tabIndex", "enabled", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"resources", "errorMessage", "caption", "immediate", "height", "width", "primaryStyleName", "description", "registeredEventListeners", "id", "readOnly", "enabled", "styles", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"registeredEventListeners", "styles", "hideErrors", "required", "modified", "errorMessage", "propertyReadOnly", "width", "readOnly", "immediate", "caption", "primaryStyleName", "height", "id", "description", "enabled", "resources", "tabIndex", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "resources", "enabled", "rpcInterfaces", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"target", "height", "immediate", "styles", "id", "enabled", "width", "errorMessage", "caption", "resources", "registeredEventListeners", "features", "primaryStyleName", "description", "readOnly", "uriFragment", "parameters", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollLeft", "tabIndex", "primaryStyleName", "resources", "caption", "id", "width", "enabled", "scrollTop", "errorMessage", "immediate", "styles", "readOnly", "height", "description", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"enabled", "description", "height", "registeredEventListeners", "styles", "resources", "readOnly", "id", "caption", "errorMessage", "html", "width", "immediate", "primaryStyleName", "hideOnMouseOut", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"resources", "registeredEventListeners", "id", "tabIndex", "errorMessage", "styles", "orientation", "required", "immediate", "value", "minValue", "caption", "resolution", "enabled", "hideErrors", "height", "maxValue", "description", "propertyReadOnly", "width", "readOnly", "primaryStyleName", "modified", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"height", "required", "caption", "enabled", "resources", "propertyReadOnly", "immediate", "errorMessage", "id", "registeredEventListeners", "readOnly", "primaryStyleName", "tabIndex", "hideErrors", "modified", "styles", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "caption", "styles", "enabled", "registeredEventListeners", "templateContents", "errorMessage", "resources", "childLocations", "id", "immediate", "width", "readOnly", "primaryStyleName", "description", "templateName", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"width", "enabled", "resources", "height", "readOnly", "caption", "immediate", "connectorToCssPosition", "id", "registeredEventListeners", "styles", "primaryStyleName", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"registeredEventListeners", "description", "resources", "primaryStyleName", "id", "immediate", "width", "readOnly", "caption", "height", "errorMessage", "styles", "alternateText", "enabled", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"modified", "registeredEventListeners", "primaryStyleName", "footer", "id", "enabled", "tabIndex", "immediate", "readOnly", "styles", "width", "required", "hideErrors", "height", "caption", "propertyReadOnly", "resources", "description", "layout", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"firstChild", "splitterState", "caption", "primaryStyleName", "id", "description", "registeredEventListeners", "secondChild", "immediate", "enabled", "width", "styles", "errorMessage", "resources", "readOnly", "height", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"immediate", "errorMessage", "readOnly", "hideErrors", "width", "primaryStyleName", "propertyReadOnly", "tabIndex", "id", "modified", "height", "caption", "resources", "description", "required", "registeredEventListeners", "enabled", "styles", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"callbackNames", "rpcInterfaces", "caption", "registeredEventListeners", "height", "id", "primaryStyleName", "description", "resources", "errorMessage", "immediate", "enabled", "readOnly", "width", "styles", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "row2", "column1", "column2", "row1", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"enabled", "width", "immediate", "styles", "height", "errorMessage", "readOnly", "caption", "id", "registeredEventListeners", "description", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"altText", "primaryStyleName", "description", "height", "registeredEventListeners", "id", "immediate", "autoplay", "width", "sources", "caption", "enabled", "htmlContentAllowed", "showControls", "sourceTypes", "styles", "muted", "errorMessage", "readOnly", "resources", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"readOnly", "immediate", "enabled", "archive", "primaryStyleName", "registeredEventListeners", "classId", "codebase", "resources", "standby", "errorMessage", "codetype", "width", "alternateText", "embedParams", "styles", "id", "height", "description", "caption", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "enabled", "immediate", "readOnly", "errorMessage", "clickShortcutKeyCode", "description", "caption", "styles", "resources", "htmlContentAllowed", "registeredEventListeners", "id", "tabIndex", "width", "height", "disableOnClick", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"registeredEventListeners", "resources", "id", "width", "height", "enabled", "splitterState", "styles", "secondChild", "immediate", "primaryStyleName", "errorMessage", "firstChild", "caption", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"width", "caption", "scrollTop", "height", "id", "resources", "styles", "resizeLazy", "positionY", "errorMessage", "primaryStyleName", "positionX", "description", "resizable", "enabled", "tabIndex", "registeredEventListeners", "immediate", "readOnly", "draggable", "modal", "centered", "scrollLeft", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"propertyReadOnly", "description", "caption", "registeredEventListeners", "id", "required", "modified", "resources", "height", "state", "immediate", "enabled", "errorMessage", "pollingInterval", "styles", "primaryStyleName", "indeterminate", "tabIndex", "width", "hideErrors", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"styles", "caption", "id", "enabled", "description", "errorMessage", "height", "immediate", "registeredEventListeners", "alternateText", "primaryStyleName", "resources", "readOnly", "width", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"styles", "id", "sourceTypes", "width", "enabled", "height", "caption", "primaryStyleName", "description", "immediate", "readOnly", "showControls", "sources", "errorMessage", "autoplay", "htmlContentAllowed", "muted", "resources", "registeredEventListeners", "altText", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"primaryStyleName", "enabled", "description", "readOnly", "height", "resources", "width", "errorMessage", "contentMode", "caption", "text", "styles", "immediate", "id", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"propertyReadOnly", "modified", "primaryStyleName", "height", "required", "enabled", "tabIndex", "styles", "readOnly", "immediate", "errorMessage", "resources", "checked", "hideErrors", "width", "id", "caption", "registeredEventListeners", "description", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"enabled", "propertyReadOnly", "caption", "description", "primaryStyleName", "width", "immediate", "required", "id", "textFieldEnabled", "height", "resources", "errorMessage", "tabIndex", "readOnly", "hideErrors", "registeredEventListeners", "modified", "styles", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"tabIndex", "text", "readOnly", "columns", "width", "resources", "styles", "propertyReadOnly", "caption", "modified", "id", "inputPrompt", "primaryStyleName", "enabled", "maxLength", "registeredEventListeners", "hideErrors", "required", "immediate", "errorMessage", "description", "height", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"caption", "styles", "id", "description", "enabled", "height", "width", "resources", "immediate", "readOnly", "primaryStyleName", "alternateText", "registeredEventListeners", "errorMessage", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"immediate", "id", "resources", "description", "caption", "styles", "width", "readOnly", "registeredEventListeners", "errorMessage", "enabled", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"resources", "propertyReadOnly", "errorMessage", "height", "immediate", "caption", "primaryStyleName", "hideErrors", "description", "width", "enabled", "readOnly", "styles", "id", "registeredEventListeners", "tabIndex", "required", "modified", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionUnit", "position", "positionReversed", "minPositionUnit", "locked", "maxPositionUnit", "maxPosition", "minPosition", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"styles", "primaryStyleName", "immediate", "readOnly", "resources", "id", "childData", "description", "marginsBitmask", "errorMessage", "enabled", "spacing", "width", "height", "registeredEventListeners", "caption", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"width", "primaryStyleName", "errorMessage", "readOnly", "resources", "caption", "immediate", "registeredEventListeners", "description", "height", "enabled", "id", "styles", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"enabled", "resources", "tabIndex", "width", "readOnly", "hideErrors", "description", "height", "id", "propertyReadOnly", "registeredEventListeners", "primaryStyleName", "modified", "errorMessage", "required", "styles", "immediate", "caption", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"caption", "columns", "required", "width", "tabIndex", "registeredEventListeners", "maxLength", "inputPrompt", "wordwrap", "modified", "styles", "enabled", "propertyReadOnly", "rows", "primaryStyleName", "immediate", "height", "resources", "id", "description", "text", "hideErrors", "errorMessage", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"width", "readOnly", "cursorX", "cursorY", "bgColor", "immediate", "id", "height", "errorMessage", "enabled", "description", "primaryStyleName", "resources", "caption", "registeredEventListeners", "styles", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"enabled", "popupVisible", "registeredEventListeners", "caption", "id", "height", "width", "resources", "color", "readOnly", "showDefaultCaption", "styles", "htmlContentAllowed", "primaryStyleName", "description", "immediate", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedColor", "rowCount", "primaryStyleName", "description", "changedX", "enabled", "resources", "changedY", "height", "caption", "columnCount", "styles", "width", "registeredEventListeners", "readOnly", "id", "immediate", "errorMessage", });
